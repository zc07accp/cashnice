...
static const CGFloat MarginTop = 54.0f;
//static const CGFloat MarginBottom = MarginTop;
static const CGFloat MarginLeft = 40.0f;
...
{
    return [self.image rotatedImageWithtransform:self.rotation croppedToRect:self.zoomedCropRect aspectRatio:(self.keepingCropAspectRatio ? self.cropAspectRatio : -1)];
}

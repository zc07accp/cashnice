...
typedef enum PhotoPreviewType {
    PhotoPreviewTypeOperation       = 0,   //Operation
    PhotoPreviewTypeDelete          = 1,   //Deletable
    PhotoPreviewTypeNone            = 2,   //None of operations
} PhotoPreviewType;
...
@property (nonatomic, assign) PhotoPreviewType photoPreviewType;

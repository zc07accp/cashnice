...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image bkColor:(UIColor *)bcColor;
...
- (void)makeToast:(NSString *)message bkColor:(UIColor *)bkColor {
    UIView *existingView = (UIView *)objc_getAssociatedObject(self, &CSToastViewKey);
    if (existingView != nil) {
        [self hideToast:existingView];
    }
    
    UIView *toast = [self viewForMessage:message title:nil image:nil bkColor:bkColor];
...
- (void)makeToastCenter:(NSString *)message {
    [self makeToast:message duration:CSToastDefaultDuration position: [NSValue valueWithCGPoint:self.center]];
}
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration  position:(id)position title:(NSString *)title image:(UIImage *)image {
    UIView *toast = [self viewForMessage:message title:title image:image  bkColor:nil];
    [self showToast:toast duration:duration position:position];  
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image bkColor:(UIColor *)bkColor {
    // sanity
    ...
    wrapperView.backgroundColor = [bkColor colorWithAlphaComponent:CSToastOpacity];

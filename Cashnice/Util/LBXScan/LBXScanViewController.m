...
//                                                      }];
        ...
        self.scanObj = [[LBXScanWrapper alloc] initZXingWithPreView:videoView cropRect:cropRect success:^(NSArray<LBXScanResult *> *array) {
            [weakSelf scanZxingResultWithArray:array];
        }];
...
- (void)scanZxingResultWithArray:(NSArray*)array
{

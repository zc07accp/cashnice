              ...
              success:(void(^)(NSArray<LBXScanResult*> *array))blockScanResult
{
    if (self = [super init])
    {
        ...
        else
        {
            ...
            [_scanZXingObj setScanRect:cropRect];
        }
 ...
 */
- (instancetype)initZXingWithPreView:(UIView *)preView cropRect:(CGRect)cropRect success:(void(^)(NSArray<LBXScanResult*> *array))blockScanResult
{
    if (self = [super init])
    {

...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        NSString *loadingPath = [imageBundle pathForResource:@"loading1" ofType:@"png"];
        _indefiniteAnimatedLayer.contents = (id)[[UIImage imageWithContentsOfFile:loadingPath] CGImage];

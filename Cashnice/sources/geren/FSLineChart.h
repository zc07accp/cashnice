...
typedef NSString *(^FSLabelForValueGetter)(CGFloat value, NSUInteger index);
...
@property (nonatomic) BOOL showLastDataPointWithBlueStyle;

@property (strong, nonatomic) BOOL (^DataPointShow) (NSInteger);
